...
class TestSearchComponents:
    ...
    def test_search_returns_matches(self):
        ...
        assert all("沙发" in r.get("name", "") or "沙发" in str(r.get("tags", [])) for r in results)
